                            ...
                            <div className="contact-social-list">
                                <span className="contact-social-item">
                                    <a href="https://platzi.com/p/crihstianmol" target="_blank" rel="noreferrer" >
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.0" viewBox="0 0 180.000000 180.000000" preserveAspectRatio="xMidYMid meet" className="svg-platzi svg-media" >
                                            <g transform="translate(0.000000,180.000000) scale(0.100000,-0.100000)" fill="#121f3d" stroke="none">
                                                <path d="M0 900 l0 -900 900 0 900 0 0 900 0 900 -900 0 -900 0 0 -900z m1037 545 c23 -10 99 -77 191 -168 130 -129 155 -159 166 -198 23 -77 2 -137 -73 -208 -25 -24 -86 -83 -136 -132 l-90 -88 -65 59 -65 60 130 131 130 130 -111 107 c-60 59 -120 115 -132 126 -21 18 -21 18 -214 -173 l-193 -190 180 -181 c99 -100 187 -185 195 -190 12 -6 32 7 80 50 l65 59 63 -62 62 -61 -67 -69 c-103 -103 -174 -128 -261 -91 -42 17 -453 420 -479 468 -20 38 -20 114 0 152 24 46 437 451 477 468 45 20 101 20 147 1z" />
                                            </g>
                                        </svg>
                                    </a>
                                </span>
                                <span className="contact-social-item">
                                    <a href="https://www.linkedin.com/in/crihstianmol/" target="_blank" rel="noreferrer" >
                                        <svg viewBox="0 0 128 128" className="svg-media">
